...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const siteData = {
        en: {
            ...
            planes: [
                { name: "F-15C Eagle", imageUrl: "plane-f15c.jpg", details: "The signature aircraft of Galm Team. A highly versatile and powerful twin-engine air superiority fighter, capable of achieving high speeds and carrying a formidable arsenal.<br><br><strong>How to Unlock:</strong> Awarded after completing Mission 9 on the Mercenary Ace style path.<br><strong>Statistics:</strong><br>  - Speed: 88<br>  - Mobility: 82<br>  - Stability: 80<br>  - Defense: 75<br>  - Air-to-Air: 90<br>  - Air-to-Ground: 70<br><strong>Weapons:</strong><br>  - SASM (Semi-Active Air-to-Air Missile)<br>  - SAAM (Semi-Active Air-to-Air Missile)<br>  - XLAA (Advanced Long-Range Air-to-Air Missile)<br><strong>Colors:</strong><br>  - Standard (Ustio)<br>  - Mercenary<br>  - Soldier<br>  - Knight<br>  - Special (Cipher)<br>  - Wingman (Pixy)" },
                { name: "Su-37 Terminator", imageUrl: "plane-su37.webp", details: "A super-maneuverable fighter flown by the ace Gelb Squadron. Its thrust-vectoring nozzles allow it to perform incredible post-stall maneuvers, making it a deadly dogfighter.<br><br><strong>How to Unlock:</strong> Awarded for shooting down Gelb Squadron in Mission 6.<br><strong>Statistics:</strong><br>  - Speed: 92<br>  - Mobility: 99<br>  - Stability: 65<br>  - Defense: 80<br>  - Air-to-Air: 95<br>  - Air-to-Ground: 72<br><strong>Weapons:</strong><br>  - FAEB (Fuel-Air Explosive Bomb)<br>  - XLAA (Advanced Long-Range Air-to-Air Missile)<br>  - QAAM (Quick Maneuver Air-to-Air Missile)<br><strong>Colors:</strong><br>  - Standard (Belka)<br>  - Mercenary (Yellow 13)<br>  - Soldier<br>  - Knight<br>  - Special (Gelb)" },
                { name: "Typhoon", imageUrl: "plane-typhoon.webp", details: "The aircraft of choice for Rot Squadron. A delta-wing multirole fighter known for its agility and high-speed performance, particularly in close-quarters combat.<br><br><strong>How to Unlock:</strong> Awarded for shooting down Rot Squadron in Mission 3 on the Mercenary Ace style path.<br><strong>Statistics:</strong><br>  - Speed: 90<br>  - Mobility: 88<br>  - Stability: 75<br>  - Defense: 82<br>  - Air-to-Air: 85<br>  - Air-to-Ground: 78<br><strong>Weapons:</strong><br>  - XLAA (Advanced Long-Range Air-to-Air Missile)<br>  - SFFS (Self-Forging Fragments Submunitions)<br>  - SOD (Stand-Off Dispenser)<br><strong>Colors:</strong><br>  - Standard (Belka)<br>  - Mercenary<br>  - Soldier<br>  - Knight<br>  - Special (Rot)" },
                { name: "J35J Draken", imageUrl: "plane-j35j.webp", details: "A unique double-delta wing fighter flown by Espada Team. It is an older but exceptionally fast and nimble aircraft, deadly in the hands of a skilled pilot.<br><br><strong>How to Unlock:</strong> Available from the start of the game.<br><strong>Statistics:</strong><br>  - Speed: 65<br>  - Mobility: 60<br>  - Stability: 50<br>  - Defense: 45<br>  - Air-to-Air: 55<br>  - Air-to-Ground: 50<br><strong>Weapons:</strong><br>  - UGB (Unguided Bomb)<br>  - RCL (Rocket Launcher)<br>  - SFFS (Self-Forging Fragments Submunitions)<br><strong>Colors:</strong><br>  - Standard<br>  - Mercenary<br>  - Soldier<br>  - Knight<br>  - Special (Espada)" },
                { name: "ADFX-02 Morgan", imageUrl: "plane-adfx02.webp", details: "A Belkan super-prototype aircraft piloted by 'Pixy' after his defection. It is equipped with advanced weaponry, including a Tactical Laser System (TLS) and Multi-Purpose Burst Missiles (MPBM).<br><br><strong>How to Unlock:</strong> Complete the campaign with all three (Soldier, Mercenary, Knight) Ace Styles.<br><strong>Statistics:</strong><br>  - Speed: 95<br>  - Mobility: 92<br>  - Stability: 85<br>  - Defense: 98<br>  - Air-to-Air: 99<br>  - Air-to-Ground: 99<br><strong>Weapons:</strong><br>  - TLS (Tactical Laser System)<br>  - MPBM (Multi-purpose Burst Missile)<br>  - ECMP (Electronic Countermeasure Pod)<br><strong>Colors:</strong><br>  - Standard<br>  - Mercenary<br>  - Soldier<br>  - Knight<br>  - Special (Pixy)" },
                { name: "ADF-01 FALKEN", imageUrl: "plane-adf01.webp", details: "An experimental, next-generation fighter developed from Morgan data. As a 'superplane,' it features a fully enclosed cockpit system and a powerful onboard Tactical Laser System.<br><br><strong>How to Unlock:</strong> Obtain all three Supreme Ace medals (The Guardian, The Destroyer, The Ravager).<br><strong>Statistics:</strong><br>  - Speed: 98<br>  - Mobility: 99<br>  - Stability: 90<br>  - Defense: 95<br>  - Air-to-Air: 99<br>  - Air-to-Ground: 92<br><strong>Weapons:</strong><br>  - TLS (Tactical Laser System)<br>  - FAEB (Fuel-Air Explosive Bomb)<br>  - XLAA (Advanced Long-Range Air-to-Air Missile)<br><strong>Colors:</strong><br>  - Standard<br>  - Mercenary<br>  - Soldier<br>  - Knight<br>  - Special (Z.O.E.)" }
            ],
            translations: {
        ...
        ja: {
            ...
            planes: [
                 { name: "F-15C イーグル", imageUrl: "plane-f15c.jpg", details: "ガルム隊の象徴的な機体。高い汎用性とパワーを誇る双発の制空戦闘機で、高速性能と強力な武装を誇る。<br><br><strong>入手方法:</strong> マーセナリーエースタイルでミッション9をクリアすると授与されます。<br><strong>統計:</strong><br>  - 速度: 88<br>  - 機動性: 82<br>  - 安定性: 80<br>  - 防御: 75<br>  - 空対空: 90<br>  - 空対地: 70<br><strong>武装:</strong><br>  - SASM (セミアクティブ空対空ミサイル)<br>  - SAAM (セミアクティブ空対空ミサイル)<br>  - XLAA (長距離空対空ミサイル)<br><strong>カラー:</strong><br>  - スタンダード (ウスティオ)<br>  - マーセナリー<br>  - ソルジャー<br>  - ナイト<br>  - スペシャル (サイファー)<br>  - ウィングマン (ピクシー)" },
                 { name: "Su-37 ターミネーター", imageUrl: "plane-su37.webp", details: "エース部隊ゲルプ隊が駆る高機動戦闘機。推力偏向ノズルにより驚異的なポストストールマニューバを可能にし、格闘戦で恐るべき性能を発揮する。<br><br><strong>入手方法:</strong> ミッション6でゲルプ隊を撃墜すると授与されます。<br><strong>統計:</strong><br>  - 速度: 92<br>  - 機動性: 99<br>  - 安定性: 65<br>  - 防御: 80<br>  - 空対空: 95<br>  - 空対地: 72<br><strong>武装:</strong><br>  - FAEB (燃料気化爆弾)<br>  - XLAA (長距離空対空ミサイル)<br>  - QAAM (高機動空対空ミサイル)<br><strong>カラー:</strong><br>  - スタンダード (ベルカ)<br>  - マーセナリー (黄色中隊)<br>  - ソルジャー<br>  - ナイト<br>  - スペシャル (ゲルプ)" },
                 { name: "タイフーン", imageUrl: "plane-typhoon.webp", details: "ロト隊が選択した機体。デルタ翼の多用途戦闘機で、特に近接戦闘における俊敏性と高速性能で知られる。<br><br><strong>入手方法:</strong> マーセナリーエースタイルでミッション3でロト隊を撃墜すると授与されます。<br><strong>統計:</strong><br>  - 速度: 90<br>  - 機動性: 88<br>  - 安定性: 75<br>  - 防御: 82<br>  - 空対空: 85<br>  - 空対地: 78<br><strong>武装:</strong><br>  - XLAA (長距離空対空ミサイル)<br>  - SFFS (自己鍛造破片弾)<br>  - SOD (スタンドオフディスペンサー)<br><strong>カラー:</strong><br>  - スタンダード (ベルカ)<br>  - マーセナリー<br>  - ソルジャー<br>  - ナイト<br>  - スペシャル (ロト)" },
                 { name: "J35J ドラケン", imageUrl: "plane-j35j.webp", details: "エスパーダ隊が駆る特徴的なダブルデルタ翼戦闘機。旧式ながら非常に高速かつ機敏な機体で、熟練パイロットの手にかかれば恐るべき存在となる。<br><br><strong>入手方法:</strong> ゲーム開始時から利用可能。<br><strong>統計:</strong><br>  - 速度: 65<br>  - 機動性: 60<br>  - 安定性: 50<br>  - 防御: 45<br>  - 空対空: 55<br>  - 空対地: 50<br><strong>武装:</strong><br>  - UGB (無誘導爆弾)<br>  - RCL (ロケットランチャー)<br>  - SFFS (自己鍛造破片弾)<br><strong>カラー:</strong><br>  - スタンダード<br>  - マーセナリー<br>  - ソルジャー<br>  - ナイト<br>  - スペシャル (エスパーダ)" },
                 { name: "ADFX-02 モルガン", imageUrl: "plane-adfx02.webp", details: "離反後の「ピクシー」が搭乗するベルカの超試作機。戦術レーザーシステム（TLS）や多目的炸裂ミサイル（MPBM）など、先進的な兵器を搭載している。<br><br><strong>入手方法:</strong> 3つのエースタイル（ソルジャー、マーセナリー、ナイト）すべてでキャンペーンをクリアする。<br><strong>統計:</strong><br>  - 速度: 95<br>  - 機動性: 92<br>  - 安定性: 85<br>  - 防御: 98<br>  - 空対空: 99<br>  - 空対地: 99<br><strong>武装:</strong><br>  - TLS (戦術レーザーシステム)<br>  - MPBM (多目的炸裂ミサイル)<br>  - ECMP (電子妨害ポッド)<br><strong>カラー:</strong><br>  - スタンダード<br>  - マーセナリー<br>  - ソルジャー<br>  - ナイト<br>  - スペシャル (ピクシー)" },
                 { name: "ADF-01 ファルケン", imageUrl: "plane-adf01.webp", details: "モルガンのデータを基に開発された実験的な次世代戦闘機。「スーパープレーン」として、完全密閉型のコックピットシステムと強力な戦術レーザーシステムを搭載する。<br><br><strong>入手方法:</strong> 3つの最高エースメダル（守護者、破壊者、略奪者）をすべて入手する。<br><strong>統計:</strong><br>  - 速度: 98<br>  - 機動性: 99<br>  - 安定性: 90<br>  - 防御: 95<br>  - 空対空: 99<br>  - 空対地: 92<br><strong>武装:</strong><br>  - TLS (戦術レーザーシステム)<br>  - FAEB (燃料気化爆弾)<br>  - XLAA (長距離空対空ミサイル)<br><strong>カラー:</strong><br>  - スタンダード<br>  - マーセナリー<br>  - ソルジャー<br>  - ナイト<br>  - スペシャル (Z.O.E.)" }
            ],
            translations: {
